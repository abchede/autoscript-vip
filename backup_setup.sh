...
IPVPS=$(curl -sS https://raw.githubusercontent.com/abchede/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/abchede/permission/main/ip >/dev/null 2>&1
...
res1() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
...
res11() {
https://raw.githubusercontent.com/abchede/autoscript-vip/main/bin/limit.sh && chmod +x limit.sh && ./limit.sh
clear
}

res12() {
wget https://raw.githubusercontent.com/abchede/autoscript-vip/main/install/ins-trgo.sh && chmod +x ins-trgo.sh && ./ins-trgo.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/abchede/permission/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/abchede/autoscript-vip/main/versi  )
